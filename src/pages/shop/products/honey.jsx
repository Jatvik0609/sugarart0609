...
import "../products.css";
import Honeysideimg from "../../../pics/micheile-henderson-7FQ43S_z6Mo-unsplash.jpg";

export const Honey = () => {
    const firstThreeProducts = PRODUCTS.slice(21, 24);

    return (
        <div className="shop">
            <div className="sideimg">
                <img src={Honeysideimg} width="100%"></img>
            </div>
