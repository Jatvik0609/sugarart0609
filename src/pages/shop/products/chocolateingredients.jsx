...
import "../products.css";
import Chocolateingredientssideimg from "../../../pics/fernanda-martinez-K0usVR9Iavs-unsplash.jpg";

export const Chocolateingredients = () => {
    const firstThreeProducts = PRODUCTS.slice(9, 12);

    return (
        <div className="shop">
            <div className="sideimg">
                <img src={Chocolateingredientssideimg} width="100%"></img>
            </div>
