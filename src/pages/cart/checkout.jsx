                ...
                <form action="" method='POST'>
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            <div className="inputBox">
                                <span>city :</span>
                                <input type="text" name="city" value={Bill.city} onChange={handleInputs} placeholder="mumbai" />
                            </div>

                            <div className="flex">
                                <div className="inputBox">
                                    <span>state :</span>
                                    <input type="text" name="state" value={Bill.state} onChange={handleInputs} placeholder="india" />
                                </div>
                                <div className="inputBox">
                                    <span>zip code :</span>
